...
if __name__ == '__main__':
    print("régression linéaire suaf carrier: ", lr1_eva_r, "\n"
        ...
        "régression linéaire sans aéroport: ", lr2_eva_r, "\n"
        "arbre de décision sans aéroport: ", dt2_eva_r, "\n"
        "régression linéaire que DepDelay: ", lr3_eva_r, "\n"
        "arbre de décision que DepDelay: ", dt3_eva_r)
